...
if((ns4)||(ie4)||(ns6)){
oframe=ol_frame;
if(ns4)over=oframe.document.overDiv3
if(ie4)over=oframe.overDiv3.style
if(ns6)over=oframe.document.getElementById("overDiv3");
}
var c=-1;
var ar=arguments;
...
if(ovpos==35){
if(oaboveheight==0){
var divref=(ie4)? oframe.document.all['overDiv3'] : over;
...
if(ns4){
if(typeof frameid.document.overDiv3=='undefined')return false;
}else if(ie4){
if(typeof frameid.document.all["overDiv3"]=='undefined')return false;
}else if(ns6){
if(frameid.document.getElementById('overDiv3')==null)return false;
}
return true;
}
...
txt +="\n";
if(ns4){
var lyr=oframe.document.overDiv3.document
lyr.write(txt)
lyr.close()
}else if(ie4){
oframe.document.all["overDiv3"].innerHTML=txt
}else if(ns6){
