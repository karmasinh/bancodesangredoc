...
if((ns4)||(ie4)||(ns6)){
oframe=ol_frame;
if(ns4)over=oframe.document.overDiv1
if(ie4)over=oframe.overDiv1.style
if(ns6)over=oframe.document.getElementById("overDiv1");
}
var c=-1;
var ar=arguments;
...
if(ovpos==35){
if(oaboveheight==0){
var divref=(ie4)? oframe.document.all['overDiv1'] : over;
...
if(ns4){
if(typeof frameid.document.overDiv1=='undefined')return false;
}else if(ie4){
if(typeof frameid.document.all["overDiv1"]=='undefined')return false;
}else if(ns6){
if(frameid.document.getElementById('overDiv1')==null)return false;
}
return true;
}
...
txt +="\n";
if(ns4){
var lyr=oframe.document.overDiv1.document
lyr.write(txt)
lyr.close()
}else if(ie4){
oframe.document.all["overDiv1"].innerHTML=txt
}else if(ns6){
