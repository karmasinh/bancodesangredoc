...
<tr class='trFilas'>
    ...
    <tr class='trFilas'>
    <TD>Fecha:::</TD>
    <TD>{$Libreta[despliegue].FECHA_A}</TD>
    <TD></TD>
    <TD></TD>
    <TD></TD>
    <TD></TD>
   ...
   <tr class='trFilas'>
    ...
    <TD>Rechazo:::</TD>
    <TD>{$Libreta[despliegue].RECHAZO}</TD>
    <TD>Numeral:::</TD>
    <TD>{$Libreta[despliegue].NUMERAL}</TD>
    </TR>
    </table>

    <tr class='trFilas'>
    <TD>Observacion:::</TD>
    <TD>{$Libreta[despliegue].OBS}</TD>
    </TR>
    <tr class='trFilas'>
    <TD>Doctor::::::</TD>
