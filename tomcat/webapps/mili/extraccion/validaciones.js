function numerocad(valor){
  ...
  if( valor.length > 0 ){
     for( var i = 0; i < valor.length; i++ ){
          d = valor.substring(i,i+1);
	  if ( digitos.indexOf( d ) != -1 ) j++;
     }
     if ( j == valor.length ){ ce='0'; } else{ ce='1'; }
  }
  else{
     ce='1';
  }
...
function validarStringNum( valorCampo, spanCampo, mensaje  ){
     var valor = DWRUtil.getValue( valorCampo );
     var ce='1';           
     if (( valor!="" )&&( numerocad(valor)=='0' )) {
          DWRUtil.setValue(spanCampo, "");
          ce='0';
     }
     else{
          DWRUtil.setValue(spanCampo, "<font color='red'><b>* "+mensaje+"</b></font>");
          ce='1';
     }
     return ce;
}
...
function numerocadena(valor){
     var digitos = "qwertyuiopasdfghjklzxcvbnm1234567890-";
     var d;
     var j=0;
     var ce='1';
  if( valor.length > 0 ){
...
function validarCadenaNumero( valorCampo, spanCampo, mensaje  ){
     var valor = DWRUtil.getValue( valorCampo );
     var ce='1';           
     if (( valor!="" )&&( numerocadena(valor)=='0' )) {
          DWRUtil.setValue(spanCampo, "");
          ce='0';
     }
     else{
...
function validarNumero( valorCampo, spanCampo, mensaje  ){
     var valor = DWRUtil.getValue( valorCampo );
     var ce='1';
     if ( EsNumeroEntero(valor)=='0' ){
          DWRUtil.setValue(spanCampo, "");
          ce='0';
     }
     else{
...
function validarReales( valorCampo, spanCampo, mensaje  ){
     var valor = DWRUtil.getValue( valorCampo );
     var ce='1';
     if ( EsNumeroReal(valor)=='0' ){
          DWRUtil.setValue(spanCampo, "");
          ce='0';
     }
     else{
...
function EsStringMili(valor){
     var digitos = "ABCDEFGHIJKLMNOPQRSTUVWXYZqwertyuioplkjhgfdsazxcvbnm";
     var d;
     var j=0;
     var ce='1';
  if( valor.length > 0 ){
...
function validarString( valorCampo, spanCampo, mensaje  ){
     var valor = DWRUtil.getValue( valorCampo );
     var ce='1';           
     if (( valor!="" )&&( EsStringMili(valor)=='0' )) {
          DWRUtil.setValue(spanCampo, "");
          ce='0';
     }
     else{
...
function EsStringMili1(valor){
     var digitos = "ABCDEFGHIJKLMNOPQRSTUVWXYZqwertyuioplkjhgfdsazxcvbnm0123456789-";
     var d;
     var j=0;
     var ce='1';
  if( valor.length > 0 ){
...
function validarString1( valorCampo, spanCampo, mensaje  ){
     var valor = DWRUtil.getValue( valorCampo );
     var ce='1';           
     if (( valor!="" )&&( EsStringMili1(valor)=='0' )) {
          DWRUtil.setValue(spanCampo, "");
          ce='0';
     }
     else{
...
function EsEmailMili1(valor){
     var digitos = "ABCDEFGHIJKLMNOPQRSTUVWXYZqwertyuioplkjhgfdsazxcvbnm0123456789@._-";
     var d;
     var j=0;
     var ce='1';
  if( valor.length > 0 ){
...
function validarEmail( valorCampo, spanCampo, mensaje  ){
     var valor = DWRUtil.getValue( valorCampo );
     var ce='1';           
     if (( valor!="" )&&( EsEmailMili1(valor)=='0' )) {
          DWRUtil.setValue(spanCampo, "");
          ce='0';
     }
     else{
...
function validarCombo( valorCampo, spanCampo, mensaje  ){
     var valor = DWRUtil.getValue( valorCampo );
     var ce='1';
     if ( valor!="-1" ){
          DWRUtil.setValue(spanCampo, "");
...
function validarFecha(valorCampo, spanCampo, mensaje){
    var valor = DWRUtil.getValue( valorCampo );
    dia  = valor.split("-")[0];
    mes  = valor.split("-")[1];
    anyo = valor.split("-")[2];
...
Calendar.prototype.getMonthlyCalendarCode = function() {
	...
	var vHeader_Code = "";
	var vData_Code = "";
	vCode += ("<span align=center><TABLE BORDER=1 BGCOLOR=\"" + this.gBGColor + "\" style='font-size:" + fontsize + "pt;'>");
...
function Build(p_item, p_month, p_year, p_format) {
	...
	if (ggPosX == -1 && ggPosY == -1) {
		overlib(ggWinContent, AUTOSTATUSCAP, STICKY, CLOSECLICK, CSSSTYLE,
			TEXTSIZEUNIT, "pt", TEXTSIZE, 9, CAPTIONSIZEUNIT, "pt", CAPTIONSIZE, 9, CLOSESIZEUNIT, "pt", CLOSESIZE, 8,
