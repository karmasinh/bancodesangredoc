...
function mostrarResultados(data) {
  aux=1;                        
  DWRUtil.addRows("camposResultados",data,[ id_aten,fecha_prueba,edad,resultado],{
    rowCreator:function(options) {
	var tr = document.createElement("tr");	
	if ((aux%2)==0){
        	tr.style.backgroundColor = "#eeeeff";
...
function insertarEF()
{
    ...
    BusquedaDAO.adicionarEF(insertarDatosEF,fecha_a,hora_a,id_aten,tipo_do,veces,cod_do,sistolica,diastolica,pulso,peso,talla,temperatura,atendido,atendidop,atendidoh,atendidos,atendidoe);
}
