...
//alert(valor+'aqui esta el valor');
...
//////////////////////para direccion
function  EsDir(valor){
     var digitos = "ABCDEFGHIJKLMNOPQRSTUVWXYZqwertyuioplkjhgfdsazxcvbnm0123456789@._-/:8080";
     var d;
     var j=0;
     var ce='1';
  if( valor.length > 0 ){
...
function validarDireccion( valorCampo, spanCampo, mensaje  ){
     var valor = DWRUtil.getValue( valorCampo );
     var ce='1';           
     if (( valor!="" )&&( EsDir(valor)=='0' )) {
          DWRUtil.setValue(spanCampo, "");
          ce='0';
     }
     else{
