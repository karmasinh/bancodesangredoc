...
var bba=DWRUtil.getValue("bb");
    ...
    var va = DWRUtil.getValue("fecha_a" );
    var dia  = va.split("-")[0];
    var mes  = va.split("-")[1];
    var anyo = va.split("-")[2];
...
//	    alert(gel[i]+"valores"+valores);
	ListaControlDAO.InsertarC(Resultado,gel[i],valores,id_aten,cod_do,fecha_a,hora_a,cod_per,id_horario,id_hemo);
	}
}
...
ListaControlDAO.InsertarC(Find,id_prueba,valores,id_aten,cod_do,fecha_a,hora_a,cod_per,id_horario,id_hemo);
...
ListaControlDAO.InsertarC(Resultado,id_prueba,valores,id_aten,cod_do,fecha_a,hora_a,cod_per,id_horario,id_hemo);
}
...
////////*********lista
var j=1;
function ListarEva(id_prod,cod_do,nombre,id_ext)
{  
DWRUtil.setValue("id_aten",id_ext);     
...
var Pruebas= function(data) {
      ...
      input.setAttribute("onclick","ListarEva("+data.id_prod+",'"+data.cod_do+"','"+data.nombre+"',"+data.id_ext+");");
