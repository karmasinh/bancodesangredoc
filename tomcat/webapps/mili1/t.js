...
ListaPreDAO.mostrar_Codper(datos,u,c);////saca el codigo del personal,fecha,id_horario
...
//  DWRUtil.addRows("camposApellido",data,[nom,apepa,apema,datos],{
  DWRUtil.addRows("camposApellido",data,[nom,apepa,apema],{
    rowCreator:function(options) {
	var tr = document.createElement("tr");	
	if ((aux%2)==0)
	{
...
DWRUtil.setValue("permitido","Usuario y/o Contraseña Incorrecta");
