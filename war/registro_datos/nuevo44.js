...
DWRUtil.setValue("cod_doCodigo",cod_do);
...
{
$(aviso).style.display='none';
//alert(parent.izquierdaAnalisis2.document.getElementById("cod_per").value);
//alert(parent.izquierdaAnalisis2.document.getElementById("id_horario").value);
