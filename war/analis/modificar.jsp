...
<head>
  ...
  <script src='modifi.js'></script>
 
  <script src='/mili1/dwr/interface/ListaSereDAO.js'></script>
...
<body onload='ListaCod_per();' >  
    ...
    <input type='hidden' id='apepa8'>
    <input type='hidden' id='apema8'>
    <input type='hidden' id='nom8'>
...
<table class='tabla' style='display' id='busqueda'>
	...
	<td align="center"><input type='text'  size='15' maxlength='10' id='apepa1'></td>
...
<table class='tabla'>
<caption class='trCaption'><h3>Modificar Inmunoserelogia</h3></caption>
<tr class='trFilas'>
